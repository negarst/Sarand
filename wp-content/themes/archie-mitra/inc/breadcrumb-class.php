...
class Breadcrumb_Trail {
	...
	protected function set_labels() {
		...
		$defaults = array(
			'browse'              => esc_html__( '&#1711;&#1586;&#1740;&#1606;&#1588; &#1601;&#1575;&#1740;&#1604;:',                               'archie' ),
			'aria_label'          => esc_attr_x( 'Breadcrumbs', 'breadcrumbs aria label', 'archie' ),
			'home'                => esc_html__( '&#1582;&#1575;&#1606;&#1607;',                                  'archie' ),
			'error_404'           => esc_html__( '404 &#1662;&#1740;&#1583;&#1575; &#1606;&#1588;&#1583;',                         'archie' ),
			'archives'            => esc_html__( '&#1576;&#1575;&#1740;&#1711;&#1575;&#1606;&#1740;',                              'archie' ),
			// Translators: %s is the search query. The HTML entities are opening and closing curly quotes.
			'search'              => esc_html__( 'Search results for &#8220;%s&#8221;',   'archie' ),
			// Translators: %s is the page number.
			'paged'               => esc_html__( '&#1589;&#1601;&#1581;&#1607; %s',                               'archie' ),
			// Translators: Minute archive title. %s is the minute time format.
			'archive_minute'      => esc_html__( '&#1583;&#1602;&#1740;&#1602;&#1607; %s',                             'archie' ),
			// Translators: Weekly archive title. %s is the week date format.
			'archive_week'        => esc_html__( '&#1607;&#1601;&#1578;&#1607; %s',                               'archie' ),
