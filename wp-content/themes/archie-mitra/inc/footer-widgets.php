...
class Archie_Pro_Footer_Widgets{
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'archie' ), $i ),
...
// Initialize.
$archie_footer_widgets = new Archie_Pro_Footer_Widgets();
