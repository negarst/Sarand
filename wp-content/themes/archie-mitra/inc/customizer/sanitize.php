...
if ( ! function_exists( 'archie_sanitize_select' ) ) :
	/**
	 ...
	 */
	function archie_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'archie_sanitize_image' ) ) :
	/**
	 ...
	 */
	function archie_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'archie_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function archie_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'archie_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Archie 1.0.0
	*/
	function archie_sanitize_page( $input ) {
...
if ( ! function_exists( 'archie_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Archie 1.0.0
	 ...
	 */
	function archie_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'archie_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Archie 1.0.0
	 */
	function archie_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'archie_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Archie 1.0.0
	 */
	function archie_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'archie_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function archie_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function archie_sanitize_switch_control( $input ) {
...
if ( ! function_exists( 'archie_sanitize_sortable' ) ) :
	/**
	...
	* @since Archie 1.0.0
	*/
	function archie_sanitize_sortable( $input ) {
