...
if ( ! class_exists( 'Archie_Pro_Latest_Post' ) ) :

     
    class Archie_Pro_Latest_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive latest posts.', 'archie' ),
            );
            parent::__construct( 'archie_latest_post', esc_html__( 'TP : Latest Posts', 'archie' ), $tp_widget_popular_post );
        }
                ...
                <li class="has-post-thumbnail clear">
                    ...
                    <a href="<?php the_permalink( $post->ID ); ?>">
                        ...
                        if ( has_post_thumbnail( $post->ID ) ) :
                            ...
                            echo '<img src="' . esc_url( get_template_directory_uri() .'/assets/uploads/no-featured-image-150x150.jpg' ) . '" alt="'. esc_attr( get_the_title() ) .'">';
                        endif; 
                        ?>
                    </a>
        ...
        public function form( $instance ) {
            $tp_title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Latest Posts', 'archie' );
            $tp_number     = isset( $instance['number'] ) ? absint( $instance['number'] ) : 3;
           ?>
           ...
           <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show:', 'archie' ); ?></label>
